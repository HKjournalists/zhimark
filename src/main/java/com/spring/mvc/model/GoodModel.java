...
public class GoodModel extends BaseModel {
    ...
    public void setXsthumb(String xsthumb) {
    ...
    public void setTotalcnf(int totalcnf) {
    ...
    public String getParcelTaxCode() {
        return parcelTaxCode;
    }

    public void setParcelTaxCode(String parcelTaxCode) {
        this.parcelTaxCode = parcelTaxCode;
    }
